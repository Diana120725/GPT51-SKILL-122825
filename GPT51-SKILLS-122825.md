...
Output Format
markdownCopy# <span style="color: coral;">Main Title</span>
...
Entity Structure
markdownCopy## Entity [N]: [Entity Name]
...
Analysis Output
markdownCopy# Entity Analysis Report
...
pyyaml==6.0.1
README.md
markdownCopy# AI Multi-API Assistant
...
Vincent van Gogh - Swirling blues and yellows, expressive brushstrokes
Claude Monet - Soft pastels, water lily motifs, impressionist blur
Pablo Picasso - Cubist geometry, bold primary colors, abstract forms
Salvador Dalí - Surreal gradients, melting effects, dreamlike atmosphere
Frida Kahlo - Vibrant Mexican colors, floral patterns, bold contrasts
Wassily Kandinsky - Abstract geometric shapes, spiritual colors
Georgia O'Keeffe - Organic curves, desert tones, flower close-ups
Jackson Pollock - Splattered patterns, chaotic energy, action painting
Andy Warhol - Pop art colors, repeated patterns, high contrast
Henri Matisse - Fauvist colors, paper cut-out shapes, bold simplicity
Edvard Munch - Emotional colors, wavy lines, expressionist mood
Gustav Klimt - Gold patterns, ornate decorations, art nouveau
Yayoi Kusama - Polka dots, infinite patterns, psychedelic colors
Banksy - Stencil effects, street art aesthetic, monochrome with red
Hokusai - Japanese waves, ukiyo-e style, indigo and white
Rothko - Color field blocks, meditative gradients, minimal
Mondrian - Primary colors, grid layouts, neo-plasticism
Basquiat - Neo-expressionist, crown motifs, street art energy
Caravaggio - Dramatic lighting, chiaroscuro, baroque elegance
Renaissance - Classical proportions, gold accents, symmetrical
...
UI Components
pythonCopy# Sidebar Configuration
with st.sidebar:
...
markdownCopy### FR-001: User Authentication
**Priority**: High
...
CopyYou are a senior software engineer conducting a thorough code review.
...
Optimized for SEO (if applicable)
...
Key Features
Interactive Widgets
pythonCopyimport ipywidgets as widgets
...
Data Analysis Template: EDA, statistics, visualization
Machine Learning Template: Full ML pipeline with model comparison
Time Series Template: Forecasting with ARIMA, Prophet
Deep Learning Template: Neural network training with TensorFlow
Statistical Analysis Template: Hypothesis testing, distributions
Web Scraping Template: BeautifulSoup, Selenium workflows
API Integration Template: REST API interaction examples
Educational Template: Step-by-step learning materials
...
Integration Tests
pythonCopy# tests/test_api_integration.py
import pytest
...
Load Tests
pythonCopy# tests/locustfile.py
...
Security Tests
pythonCopy# tests/test_security.py
import pytest
...
Example Usage
pythonCopy# Build knowledge graph from document
...
Summary Table
Skill #NamePrimary FunctionOutput FormatWord CountTriggers1PDF to MarkdownConvert PDF to MD with summaryMarkdown4000-5000pdf, pdf file, convert pdf2Document OrganizerOrganize docs with coral keywordsMarkdown4000-5000docx, organize, keywords3Entity AnalyzerExtract 20 entities with contextMarkdown4000-5000entities, NER, extraction4Streamlit BuilderMulti-API app generationPython/YAMLN/Astreamlit, api, deployment5UI DesignerTransform UI with themes/stylesPython/CSSN/Aui design, themes, styles6Tech Spec GeneratorComprehensive specificationsMarkdown6000-7000tech specs, SRS, architecture7Table Summary10-table comprehensive summaryMarkdown6000-7000tables, data summary8Jupyter GeneratorInteractive notebook creation.ipynbN/Ajupyter, notebook, ipynb9Test Suite GeneratorAPI testing automationPythonN/Aapi testing, pytest, tests10Knowledge GraphBuild semantic networksMultipleN/Aknowledge graph, ontology

Document Version: 1.0
Last Updated: 2024-01-15
Total Skills: 10
Total Word Count: ~8500 words
